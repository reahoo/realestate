...
This sample app is a mobile web app for [Reahoo](https://reahoo.herokuapp.com/) that runs on Heroku and optionally uses Heroku Connect to get data from Salesforce.  Check out a demo:
...
1. Create a database in Postgres named `reahoo`
...
1. [![Deploy on Heroku](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/reahoo/realestate)
...
1. [Install the Reahoo package into the org](https://reahoo.herokuapp.com/installation/)
